package com.eazybites.jobportal.aspects;


import com.eazybites.jobportal.dto.RegisterRequestDto;
import com.eazybites.jobportal.entity.JobPortalUser;
import com.eazybites.jobportal.exception.RegistrationValidationException;
...
public class RegisterValidationAspect {
    ...
    @Before("""
        execution(* com.eazybites.jobportal.auth.AuthController
        .registerUser(..))
        """)
