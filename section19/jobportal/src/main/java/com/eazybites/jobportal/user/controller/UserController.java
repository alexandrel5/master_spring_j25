package com.eazybites.jobportal.user.controller;

import com.eazybites.jobportal.dto.*;
...
public class UserController {
    ...
    public ResponseEntity<byte[]> getProfilePicture(Authentication authentication) {
        String userEmail = authentication.getName();
        com.eazybites.jobportal.dto.ProfileDto profileDto = userService.getProfilePicture(userEmail);
    ...
    public ResponseEntity<byte[]> getResume(Authentication authentication) {
        String userEmail = authentication.getName();
        com.eazybites.jobportal.dto.ProfileDto profileDto = userService.getResume(userEmail);
